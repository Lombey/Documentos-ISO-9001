...
## 📅 Hitos Calendario 2026

| Período | Actividad Táctica | Referencia SGC | Estado |
| :--- | :--- | :--- | :--- |
| **Enero** | **Control de Docs (Reingeniería):** Adaptar PGs para eliminar burocracia. | PG 01 | ✅ **Local Listo** |
| **Enero** | **Definición de KPIs (ICP/IMR):** Configurar métricas de consolidación. | PG 02 | ✅ **Local Listo** |
| **Enero** | **Gestión de NC Digital:** Integración del flujo de calidad en AppSheet. | PG 03 | ✅ **Local Listo** |
...
## 🔄 Rutinas de Control (Operación 2026)

| Frecuencia | Tarea Táctica | Referencia SGC |
| :--- | :--- | :--- |
| **Semanal** | **Conciliación Xubio-AppSheet:** Sincronización de estados de cobro. | PG 05 |
| **Trimestral** | **Actualización de Instructivos (PP 05 02):** Basada en fallas repetitivas. | PG 05 |
| **Semanal** | **Check de Integridad Backend (Google Sheets):** Seguridad de datos. | PG 01 |

---

## 📝 Notas de Implementación

* **Fuente de Verdad:** AppSheet centraliza todos los registros. Se prohíbe el uso de silos de información externos.
* **Métricas Clave:**
  * **ICP:** Índice de Consolidación de Procesos (Meta: 100%).
  * **IMR:** Índice de Mitigación de Recurrencia (Basado en análisis de causas).
* **NC #131 y #130:** El éxito de este cronograma cierra ambas no conformidades.
